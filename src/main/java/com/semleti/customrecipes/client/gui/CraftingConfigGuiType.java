 ...
 */
public class CraftingConfigGuiType extends GuiConfigEntries.ButtonEntry
{
    protected final boolean beforeValue;
    protected boolean       currentValue;

    public CraftingConfigGuiType(GuiConfig owningScreen, GuiConfigEntries owningEntryList, IConfigElement configElement)
    {
    ...
    {
        this.btnValue.displayString = I18n.format(String.valueOf(currentValue) + " customized");
        btnValue.packedFGColour = currentValue ? GuiUtils.getColorCode('7', true) : GuiUtils.getColorCode('0', true);
    }
